...
#BCM_4(0.2, 0.3, 0.4) => num_qubits = 7
...
#creating O_C
O_C = QuantumCircuit(6, name="O_C")
O_C.x(0)
O_C.x(1)
O_C.append(cc_R_Shift_gate, [0,1,2,3,4,5])
O_C.x(0)
O_C.x(1)
O_C.barrier()
O_C.x(1)
O_C.append(cc_L_Shift_gate, [0,1,2,3,4,5])
O_C.x(1)



#creating BCM circuit
BCM = QuantumCircuit(7, 7)
BCM.reset(range(7))
...
BCM.barrier()
BCM.append(O_C, [1,2,3,4,5,6])
BCM.barrier()
BCM.h(1)
BCM.h(2)
BCM.barrier()
BCM.measure([i for i in range(7)], [i for i in range(7)])
